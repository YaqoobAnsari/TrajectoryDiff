...
def evaluate_baselines(
    ...
    for name in all_baseline_names:
        ...
        # Per-sample arrays for downstream significance testing
        summary[name]["per_sample_rmse_free_unobs_dbm"] = r["rmse_free_unobs_dbm"]
        summary[name]["per_sample_rmse_free_space_dbm"] = r["rmse_free_space_dbm"]
        summary[name]["per_sample_rmse_free_obs_dbm"] = r["rmse_free_obs_dbm"]
        summary[name]["per_sample_ssim_free_space"] = r["ssim_free_space"]
